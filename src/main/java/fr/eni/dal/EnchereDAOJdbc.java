...
public class EnchereDAOJdbc implements EnchereDAO {
    ...
    private static final String SELECT_ALL_ENCHERES_BY_ARTICLE_ID = "SELECT * FROM ENCHERES WHERE no_article=? ORDER BY montant_enchere DESC";
    ...
    public List<Enchere> selectByIdArticle(int idArticle) {
        ...
        try (Connection cnx = ConnectionProvider.getConnection()) {
            PreparedStatement pstmt = cnx.prepareStatement(SELECT_ALL_ENCHERES_BY_ARTICLE_ID);
