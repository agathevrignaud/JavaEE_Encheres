...
VALUES ('admin', 'admin', 'admin', 'admin@email.com', '0123456789', 'rue truc', '35000', 'Rennes', 'mdp', 1);
...
VALUES ('PC Gaming', 'Très Bon Etat Général', '07-09-2021', '10-09-2021', 150, 150, 'E', 1, 1),
...
VALUES (1, '2 rue Beaulieu', 35400, 'RENNES'),
       (2, '22 rue Pierre Jacques', 92000, 'PARIS');